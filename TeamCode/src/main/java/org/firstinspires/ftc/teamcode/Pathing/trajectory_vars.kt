...
object auto_trajectories{
    ...
    // 2 = truss
    @JvmField
    val Preload0Red = Trajectory(Pose(0.0,0.0,0.0), Pose(65.0, 20.0, 3* PI /2))
    @JvmField
    ...
    val anotherintermediarytraj2Red = Trajectory(Pose(60.0, -30.0,  PI / 2), Pose(60.0, -44.0,  PI / 2))
    ...
    val intermediarytraj0Red = Trajectory(Pose(65.0, 20.0, 3*PI/2), Pose(20.0, 10.0, 3*PI/2))
    ...
    // 2 = truss
    @JvmField
    val Preload0Blue = Trajectory(Pose(0.0,0.0,0.0), Pose(60.0, -10.0, PI /2))
    @JvmField
    val Preload1Blue = Trajectory(Pose(0.0,0.0,0.0), Pose(60.0, -5.0, 0.0))
    @JvmField
    val Preload2Blue = Trajectory(Pose(0.0,0.0,0.0), Pose(60.0, 20.0,   3 * PI / 2))

    @JvmField
    val intermediarytraj2blue =  Trajectory(Pose(60.0, 30.0,  3 * PI / 2), Pose(50.0, -20.0, PI /2))
    val anotherintermediarytraj2blue = Trajectory(Pose(60.0, 20.0,  3* PI / 2), Pose(60.0, 30.0,  3 * PI / 2))
    val intermediarytraj0Blue = Trajectory(Pose(60.0, 20.0, PI/2), Pose(50.0, -50.0,  PI/2))


    val PreloadtoBack0Blue = Trajectory(Pose(50.0, 50.0, 3*PI /2), Pose(25.0, -90.0,   PI /2))
    @JvmField
    val PreloadtoBack1Blue = Trajectory(Pose(65.0, 5.0, 0.0), Pose(40.0, -90.0, PI/2))
    @JvmField
    val PreloadtoBack2Blue = Trajectory(Pose(50.0, -20.0, PI/2), Pose(50.0, -90.0, PI / 2))
    ...
    val Park1Blue = Trajectory(Pose(40.0, -90.0, PI / 2), Pose(-20.0, -90.0, PI / 2))
    val Park0Blue = Trajectory(Pose(25.0, -90.0, PI / 2), Pose(-20.0, -90.0, PI / 2))
    val Park2Blue = Trajectory(Pose(50.0, -90.0, PI / 2), Pose(-20.0, -90.0, PI / 2))
    @JvmField
