...
import org.firstinspires.ftc.teamcode.Variables.system_vars.imuoffset
...
class ThreadedIMU(val name: String) {
    ...
    fun init() {
        ...
        thread.setUncaughtExceptionHandler { th, er -> autoupdate_tp(tp, "GOT ERR TIMMY ${th.id}", er.stackTraceToString()) }
